export const translations = {
  en: {
    ...
    "index.projects.weboneko": "A sandboxed, creative micro-social platform where every post is a customizable HTML/CSS webpage. Features data scarcity mechanics, a nibbles economy, and multi-stage content moderation.",
    ...
    "weboneko.core.scarcity.text": "Users get a 256KB data budget per 4-hour cycle. This encourages intentional, thoughtful posts rather than endless scrolling and spam.",
    ...
    "weboneko.moderation.text": "A multi-stage moderation pipeline keeps the platform safe. First, a keyword blocklist catches obvious violations. Then, an ML model (IBM Granite Guardian) performs deeper analysis. The system is fail-closed — if anything goes wrong, content is flagged for manual review rather than published.",
    ...
    "weboneko.tech.database": "Database: SQLite with WAL mode",
  ...
  lt: {
    ...
    "index.projects.weboneko": "Izoliuota, kūrybinė mikro-socialinė platforma, kurioje kiekvienas įrašas yra individualizuojamas HTML/CSS tinklalapis. Turi duomenų trūkumo mechanikas, nibbles ekonomiką ir daugiapakopę turinio moderaciją.",
    ...
    "weboneko.core.scarcity.text": "Vartotojai gauna 256KB duomenų biudžetą per 4 valandų ciklą. Tai skatina apgalvotus įrašus, o ne begalinį slinkimą ir šlamštą.",
    ...
    "weboneko.moderation.text": "Daugiapakopė moderacijos sistema užtikrina platformos saugumą. Pirmiausia, raktinių žodžių blokavimo sąrašas pagauna akivaizdžius pažeidimus. Tada ML modelis (IBM Granite Guardian) atlieka gilesnę analizę. Sistema veikia fail-closed principu — jei kas nors sugenda, turinys pažymimas rankinei peržiūrai, o ne publikuojamas.",
    ...
    "weboneko.tech.database": "Duomenų bazė: SQLite su WAL režimu",
